...
export const en: typeof zh = {
  ...
  contacts: 'CONTACTS',
  products: 'PRODUCTS',
  landingSearchPlaceholder: 'SEARCH MOONLESS',

  // Hero Section
  sloganLine1: 'nothing',
  sloganLine2: 'is impossible',
  heroTitle: 'MOONLESS',
  heroCategory: 'DECENTRALIZED OKF KNOWLEDGE SYSTEM',
  ...
  // Weather and Meta
  weatherStatus: 'DECENTRALIZED STORAGE CLEAR, Fast read-write. No seat fees.',
  ...
  // Join Us Article
  joinUsTitle: 'JOIN US TO BUILD DECENTRALIZED KNOWLEDGE',
  joinUsText: 'Join us and build your decentralized private knowledge system, free from cloud bindings, and enjoy a pure, unobstructed, and ultra-fast personal knowledge management experience. Three modules share the same OKF contract—change in one place, take effect globally. Run fully decentralized without monthly seat fee.',
  ...
  editorNeedsText: 'MOON editor runs inside the browser sandbox, using File System Access API for decentralized directory sync without server-side storage. Changes write directly to disk, resolving filename conflicts and increments dynamically.',
  ...
  architectureText: 'MOONLESS is built on top of a pnpm workspaces monorepo. It operates fully isolated inside a client-side Web App using decentralized computation. Credentials and personal notes are never uploaded. Uses Google OKF as the main data contract.',
  ...
  dataFlow2: '2. MOON: Decentralized WYSIWYG Editor reading/writing OKF Markdown files with auto-saved structure.',
  ...
  shotTitle: 'TRENDING! DECENTRALIZED RAG KNOWLEDGE ENGINE',
  shotText: 'Decentralized knowledge shouldn\'t just be static files. SHOT (Knowledge Engine) builds an Agent data pipeline: supports semantic vector retrieval of OKF Markdown chunks alongside MiniSearch keywords; scans relative paths to build memory Spaces Maps and Graph topologies; and exposes standard JSON API endpoints for external AI Agents to retrieve context.',
